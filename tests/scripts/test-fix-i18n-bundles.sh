#!/usr/bin/env bash
# Checks fix-i18n-bundles.py on a synthetic plugin: each of the four repairs, and what it must leave alone.
set -u
...
if [ $fail = 0 ]; then echo "PASS: fix-i18n-bundles repairs I18N05, I18N06, I18N01, I18N09 and keeps the rest"; else cat "$T/out.txt"; exit 1; fi
